...
display.set_caption("AEROCOOL VX+")
...
w1 = GameSprite('stena.jpg',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('stena.jpg', 370, 100, 50, 400)
...
final_sprite = GameSprite('CHORT.png', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy('Nitroglycerin.svg.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('Nitroglycerin.svg.png', win_width - 80, 230, 80, 80, 5)
